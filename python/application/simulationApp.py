...
class SimulationApp:
    ...
    def getNextCommand(self, index):
        ...
        v, angularVel = self.myRobot.TrackingController.calculateTrackingControl(self.OldX, RefVelocity,
                                                                                 RefAngularVelocity,
                                                                                 self.reference_trajectory[:, index])
        return v, angularVel
    ...
    def exitApp(self):
        ...
        plt.figure(1)
        plt.subplot(311)
        reference_pos, = plt.plot(self.reference_trajectory[0], self.reference_trajectory[1], 'green',
